...
public class MyMoneyNumberActivity extends BaseBussActivity{
    private ImageView app_back;
    private TextView top_title_tv;
    @Override
    protected void setLayout(Bundle savedInstanceState) {
        super.setLayout(savedInstanceState);
        _context=MyMoneyNumberActivity.this;
        setContentView(R.layout.activity_my_money_number);
    }
